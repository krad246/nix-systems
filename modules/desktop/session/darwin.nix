{lib, ...}: {
  ...
  in {
    options.desktop.session.darwin.enable =
    ...
    config = lib.modules.mkIf session.enable {
      targets.darwin = {
        ...
        defaults = {
          ...
          "com.apple.HIToolbox".AppleFnUsageType = "Do Nothing";
          ...
          "com.apple.dock" = {
            ...
            persistent-apps = map toDockAppTile (lib.lists.filter (app: app != null) (map (id:
              {
