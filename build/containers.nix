...
in
  ...
  // {
    ...
    in {
      x86_64-linux.ubuntu = pullImage "x86_64-linux" {
        imageName = "ubuntu";
      ...
      x86_64-linux.nix-flakes = pullImage "x86_64-linux" {
      ...
      x86_64-linux.nixos = pullImage "x86_64-linux" {
        imageName = "nixos/nix";
      ...
      aarch64-linux.ubuntu = pullImage "aarch64-linux" {
        imageName = "ubuntu";
        imageDigest = "sha256:99c35190e22d294cdace2783ac55effc69d32896daaa265f0bbedbcde4fbe3e5";
      ...
      aarch64-linux.nix-flakes = pullImage "aarch64-linux" ({pkgs, ...}:
      ...
      aarch64-linux.nixos = pullImage "aarch64-linux" {
        imageName = "nixpkgs/nix-flakes";
        imageDigest = "sha256:a6de74beafbf1d1934e615b98602f1975e146ab7a3154e97139b615cb804d467";
        sha256 = "1kd83s9y26jsrnwy4gxchl6ir2c8p8h95m2f22p070p32ig3ljxb";
        finalImageName = "nixpkgs/nix-flakes";
